                        ...
                        <div class="card-body pb-0">
                            <div class="btn-group float-right">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a class="dropdown-item" href="{{ route('backend.manufacturers.index') }}">More details</a>
                                </div>
                            </div>
                            <div class="text-value-lg">{{ $manufacturersTotal }}</div>
                            <div>{{ trans('menus.backend.tecdoc.cars.manufacturers.title') }}</div>
                        </div>
                    ...
                    <div class="card text-white bg-info">
                        <div class="card-body pb-0">
                            <div class="btn-group float-right">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a class="dropdown-item" href="{{ route('backend.models.index') }}">More details</a>
                                </div>
                            </div>

                            <div class="text-value-lg">{{ $modelsTotal }}</div>
                            <div>{{ trans('menus.backend.tecdoc.cars.models.title') }}</div>
                        </div>
                        <div class="c-chart-wrapper mt-3 mx-3" style="height:70px;">
                    ...
                    <div class="card text-white bg-warning">
                        <div class="card-body pb-0">
                            <div class="btn-group float-right">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a class="dropdown-item" href="{{ route('backend.vehicles.index') }}">More details</a>
                                </div>
                            </div>
                            <div class="text-value-lg">{{ $vehiclesTotal }}</div>
                            <div>{{ trans('menus.backend.tecdoc.cars.vehicles.title') }}</div>
                        </div>
                    ...
                    <div class="card text-white bg-danger">
                        <div class="card-body pb-0">
                            <div class="btn-group float-right">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a class="dropdown-item" href="{{ route('backend.brands.index') }}">More details</a>
                                </div>
                            </div>
                            <div class="text-value-lg">{{ $brandsTotal }}</div>
                            <div>{{ trans('menus.backend.tecdoc.articles.brands.title') }}</div>
                        </div>
                        <div class="c-chart-wrapper mt-3 mx-3" style="height:70px;">
