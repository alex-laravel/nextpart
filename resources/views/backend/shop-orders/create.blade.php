...
@section('content')
    {{ Form::open(['route' => 'backend.orders.store', 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'POST']) }}

    <div class="card card-accent-warning">
        <div class="card-header">
            <h4 class="d-inline-block">{{ trans('labels.backend.orders.create') }}</h4>
...
{{--                <div class="col-lg-10">--}}
{{--                    {{ Form::text('title', null, ['class' => 'form-control', 'maxlength' => '255', 'required' => 'required', 'autofocus' => 'autofocus', 'placeholder' => trans('labels.backend.orders.table.title')]) }}--}}
{{--                </div>--}}
{{--            </div>--}}
...
{{--                <div class="col-lg-10">--}}
{{--                    {{ Form::text('description', null, ['class' => 'form-control', 'maxlength' => '455', 'placeholder' => trans('labels.backend.orders.table.description')]) }}--}}
{{--                </div>--}}
{{--            </div>--}}
        </div>
