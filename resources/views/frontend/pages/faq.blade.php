...
@section('meta_title', trans('meta.pages.faq.title'))
@section('meta_description', trans('meta.pages.faq.description'))
@section('meta_keywords', trans('meta.pages.faq.keywords'))
        ...
        <div class="block faq">
            <div class="container container--max--xl">
                <div class="faq__header">
                    <h1 class="faq__header-title">{{ trans('meta.pages.faq.title') }}</h1>
                </div>
                ...
                <div class="faq__footer">
                    ...
                    <a href="{{ route('frontend.pages.contacts') }}" class="btn btn-primary">
