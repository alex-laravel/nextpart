...
@section('meta_title', trans('meta.pages.delivery.title'))
@section('meta_description', trans('meta.pages.delivery.description'))
@section('meta_keywords', trans('meta.pages.delivery.keywords'))
            ...
            <div class="container">
                <div class="document">
                    <div class="document__header">
                        <h1 class="document__title">{{ trans('meta.pages.delivery.title') }}</h1>
                    </div>
