...
@section('meta_title', trans('meta.pages.terms.title'))
@section('meta_description', trans('meta.pages.terms.description'))
@section('meta_keywords', trans('meta.pages.terms.keywords'))
            ...
            <div class="container">
                <div class="document">
                    <div class="document__header">
                        <h1 class="document__title">{{ trans('meta.pages.terms.title') }}</h1>
