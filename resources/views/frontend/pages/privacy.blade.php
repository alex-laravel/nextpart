...
@section('meta_title', trans('meta.pages.privacy.title'))
@section('meta_description', trans('meta.pages.privacy.description'))
@section('meta_keywords', trans('meta.pages.privacy.keywords'))
            ...
            <div class="container">
                <div class="document">
                    <div class="document__header">
                        <h1 class="document__title">{{ trans('meta.pages.privacy.title') }}</h1>
                    </div>
