...
@section('meta_title', trans('meta.articles.brand.title'))
@section('meta_description', trans('meta.articles.brand.description'))
@section('meta_keywords', trans('meta.articles.brand.keywords'))
        ...
        <div class="block-header block-header--has-breadcrumb block-header--has-title">
            <div class="container">
                <div class="block-header__body">
                    ...
                    {{--                        </ol>--}}
                    {{--                    </nav>--}}
                    <h1 class="block-header__title">{{ trans('meta.articles.brand.title') . ': Бренд [' . $brand->brandName . ']' }}</h1>
                </div>
            </div>
        </div>
