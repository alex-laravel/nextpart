...
@section('meta_title', trans('meta.articles.details.title'))
@section('meta_description', trans('meta.articles.details.description'))
@section('meta_keywords', trans('meta.articles.details.keywords'))
                        ...
                        <div class="product product--layout--full">
                            <div class="product__body">
                                        ...
                                        <div class="product-gallery__featured">
                                            ...
                                            <div class="owl-carousel">
                                                @foreach ($part->photos as $photo)
                                                    <a class="image image--type--product" href="{{ asset('assets/articles/' . $photo->assetDocumentName) }}" target="_blank" data-width="700" data-height="700">
                                                        <div class="image__body">
                                                            <img class="image__tag" src="{{ asset('assets/articles/' . $photo->assetDocumentName) }}" alt="">
                                                        </div>
                                                    </a>
                                                @endforeach
                                            </div>
                                ...
                                <div class="product__header">
                                    <h1 class="product__title">{{ $part->articleName }}</h1>
                                            ...
                                            <div class="product__prices-stock">
                                                <div class="product__prices">
                                                    <div class="product__price product__price--current">
                                                        @if(isset($part->product[0]['price']) && $part->product[0]['price'] > 0)
                                                            <span>{{ productPriceFormatted($part->product[0]['price']) }} {{ trans('strings.general.hrn') }}</span>
                                                        @endif
                                                    </div>
                                                </div>
...
{{--                                        </div>--}}
                                        <div class="product__actions">
                                            ...
                                            <div class="product__actions-item product__actions-item--addtocart">
                                                <a class="btn btn-primary btn-lg btn-block" href="{{ route('frontend.cart.add', $part->id) }}" role="button">
                                                    ...
                                                    <div class="spec__section">
                                                        ...
                                                        @foreach ($part->articleAttributes['array'] as $articleAttribute)
                                                            <div class="spec__row">
                                                                ...
                                                                <div class="spec__value">{{ $articleAttribute['attrValue'] }}</div>
                                                            </div>
                                                        @endforeach
                                                    </div>
                                                    {{--                                                <div class="spec__section">--}}
                                        ...
                                        <div class="product-tabs__pane" id="product-tab-analogs">
                                            @if($part->analogs)
                                                <table class="analogs-table">
                                                    <thead>
                                                    <tr>
                                                        <th class="analogs-table__column analogs-table__column--name">{{ trans('labels.frontend.analogs.name') }}</th>
                                                        <th class="analogs-table__column analogs-table__column--vendor">{{ trans('labels.frontend.analogs.brand') }}</th>
                                                        <th class="analogs-table__column analogs-table__column--price">{{ trans('labels.frontend.analogs.price') }}</th>
                                                    ...
                                                    @foreach ($part->analogs as $analog)
                                                        <tr>
                                                            <td class="analogs-table__column analogs-table__column--name">
                                                                <a href="{{ route('frontend.parts.details', $analog->articleId) }}" class="analogs-table__product-name">{{ $analog->articleName }}</a><br>
...
{{--                                                                <div class="analogs-table__country">(Germany)</div>--}}
                                                            ...
                                                            <td class="analogs-table__column analogs-table__column--price">
                                                                @if(isset($analog->product[0]['price']) && $analog->product[0]['price'] > 0)
                                                                    {{ productPriceFormatted($analog->product[0]['price']) }} {{ trans('strings.general.hrn') }}
                                                                @else
                                                                    <div class="status-badge status-badge--style--failure product__stock status-badge--has-text">
                                                                        <div class="status-badge__body">
                                                                            <div class="status-badge__text text-nowrap">{{ trans('labels.frontend.product.status.out_of_stock') }}</div>
...
{{--                                                        </div>--}}
{{--                                                        <button class="product-card__addtocart-icon" type="button" aria-label="{{ trans('buttons.frontend.shop.add_to_cart') }}">--}}
