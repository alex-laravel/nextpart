...
@section('meta_title', trans('meta.articles.vehicle.title'))
@section('meta_description', trans('meta.articles.vehicle.description'))
@section('meta_keywords', trans('meta.articles.vehicle.keywords'))
...
@section('content')
    <div class="site__body">
        <div class="block-header block-header--has-breadcrumb block-header--has-title">
            <div class="container">
                <div class="block-header__body">
                    ...
                    {{--                        </ol>--}}
                    {{--                    </nav>--}}
                    <h1 class="block-header__title">{{ trans('meta.articles.vehicle.title') . ': Марка ' . $manufacturerName . ' - Модель ' . $modelSeriesName . ' - Транспортное средство ' . $vehicleName }}</h1>
                </div>
            </div>
        </div>
        ...
        <div class="block-split">
            ...
            <div class="container">
                @include('frontend.shared.vehicle')
