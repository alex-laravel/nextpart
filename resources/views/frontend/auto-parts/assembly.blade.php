...
@section('meta_title', trans('meta.articles.assembly.title'))
@section('meta_description', trans('meta.articles.assembly.description'))
@section('meta_keywords', trans('meta.articles.assembly.keywords'))
...
{{--                        </ol>--}}
{{--                    </nav>--}}
                    <h1 class="block-header__title">{{ trans('meta.articles.assembly.title') . ': Сборочная группа [' . $assemblyGroup->assemblyGroupName . ']' }}</h1>
                </div>
            </div>
        </div>
