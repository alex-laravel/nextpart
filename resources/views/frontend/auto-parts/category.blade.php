...
@section('meta_title', trans('meta.articles.category.title'))
@section('meta_description', trans('meta.articles.category.description'))
@section('meta_keywords', trans('meta.articles.category.keywords'))
        ...
        <div class="block-header block-header--has-breadcrumb block-header--has-title">
            <div class="container">
                <div class="block-header__body">
                    ...
                    {{--                        </ol>--}}
                    {{--                    </nav>--}}
                    <h1 class="block-header__title">{{ trans('meta.articles.category.title') . ': Категория [' . $shortCut->shortCutName . ']'  }}</h1>
                </div>
            </div>
        </div>
